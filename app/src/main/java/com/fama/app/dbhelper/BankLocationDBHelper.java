package com.fama.app.dbhelper;

import android.app.Activity;

import com.fama.app.activity.App;
import com.fama.app.greendaodb.BankDetail;
import com.fama.app.greendaodb.BankDetailDao;
import com.fama.app.greendaodb.DaoSession;
...
public class BankLocationDBHelper {
    ...
    public ArrayList<BankDetail> getBankNameList(Activity activity,String kind) {
        daoSession = ((App) activity.getApplication()).getDaoSession();
        bankDetailDao = daoSession.getBankDetailDao();
        QueryBuilder qb;
        /**
