...
/************* Fama Wallet History   *************/
    ...
    @GET("rest/FamaWalletHistory/getFamaWalletUsedAmountList/{userId}/{numberOfDays}")
    Call<List<GraphHistory>> getFamaWalletUsedAmountList(@Path("userId") String userId,@Path("numberOfDays") int numberOfDays);
