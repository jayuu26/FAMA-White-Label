...
public class SummaryFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, AboutListAdapter.OnItemClickListener {
    ...
    public enum Single {
        INSTANCE;
        SummaryFragment s = new SummaryFragment();

        public SummaryFragment getInstance() {
            if (s == null)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup mainView = (ViewGroup) inflater.inflate(R.layout.summary, container, false);
        if (mainView != null) {
