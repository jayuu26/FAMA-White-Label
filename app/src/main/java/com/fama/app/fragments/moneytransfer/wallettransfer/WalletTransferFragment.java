...
import com.fama.app.adapter.transferadapter.wallet.WalletTransferListAdapter;
import com.fama.app.fragments.moneytransfer.bkashtransfer.WalletToBkashkTransferFragment;
    ...
    public void onPopupBtnClicked(Object results, int position) {
        ...
        switch (position) {
            ...
            case 1:
                ...
                break;
            case 2:
                AppUtills.loadFragment(WalletToBkashkTransferFragment.Single.INSTANCE.getInstance(), getActivity(), R.id.container);
                break;
        }
    }
