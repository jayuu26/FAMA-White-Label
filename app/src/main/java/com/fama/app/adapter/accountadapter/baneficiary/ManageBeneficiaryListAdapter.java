package com.fama.app.adapter.accountadapter.baneficiary;
 ...
 */
public class ManageBeneficiaryListAdapter extends RecyclerView.Adapter<ManageBeneficiaryListAdapter.ViewHolder> {
    private Context mContext;
    private OnItemClickListener listener;

    String sub_title[] = {"Add Beneficiary", "View Beneficiary"};
    int icons[] = {R.drawable.existingaccount, R.drawable.newaccount};
    ...
    public ManageBeneficiaryListAdapter(Context mContext, ArrayList<Object> myDataset, OnItemClickListener onItemClickListener) {
    ...
    @Override
    public ManageBeneficiaryListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                      int viewType) {
        // create a new view
