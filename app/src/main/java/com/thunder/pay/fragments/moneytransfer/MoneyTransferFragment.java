package com.thunder.pay.fragments.moneytransfer;
...
import com.thunder.pay.fragments.bills.RecentFragment;
import com.thunder.pay.fragments.bills.ScheduledFragment;
...
public class MoneyTransferFragment extends Fragment {
    ...
    public enum Single {
        INSTANCE;
        MoneyTransferFragment s = new MoneyTransferFragment();

        public MoneyTransferFragment getInstance() {
            if (s == null)
...
//                        getActivity().onBackPressed();
        ...
        AppUtills.setActionBarTitle("Money Transfer", ((AppCompatActivity) getActivity()).getSupportActionBar(), getActivity(), true);
...
//        mAdView.loadAd(adRequest);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(BankTransferFragment.Single.INSTANCE.getInstance(), "Bank Transfer");
        adapter.addFrag(WalletTransferFragment.Single.INSTANCE.getInstance(), "Wallet Transfer");
